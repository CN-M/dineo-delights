      ...
      <div className="container">
        ...
        <ul className="footer-nav-list">
          ...
          <li className="footer-nav-item flex">
            ...
            <a href="tel:+2712345678" className="footer-nav-link">(+27) 123-4567-890</a>
          </li>
          ...
          <li className="footer-nav-item flex">
            ...
            <a href="mailto:dineo.mohale@gmail.com" className="footer-nav-link">example@gmail.com</a>
          </li>
    ...
    <div className="footer-bottom">
      ...
      <div className="container">
        ...
        <p className="copyright">
          Copyright &copy; 2023 <a href="/">Dineo&apos;s Delights</a> all rights reserved.
        </p>
